...
<body>
    <?php 
        ...
        // kiểm tra vào trang tài khoản chưa
        ...
        $query = "SELECT * FROM `user` WHERE `id_user` = '$idUser' AND `role` = 0";
	...
	<main style="min-height: 100vh; max-width: 100%;">
        <?php 
            $cauHoi = "SELECT * FROM `cau_hoi` WHERE `id_user` = '$idUser'";
            ...
            $xoaTaiKhoan = "DELETE FROM `user` WHERE `id_user` = '$idUser'";
            if (mysqli_query($conn, $xoaTaiKhoan)) {
                echo '<div class="alert alert-success text-center" role="alert">Xóa tài khoản thành công</div>';
        ...
        ?>
        <a href="tai_khoan.php" class="btn btn-outline-success">Trở lại</a>
	</main>
